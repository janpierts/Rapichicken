...
namespace RapiChicken.Datos
{
    ...
    {
        public List<CatalogoModel> Listar()
        {
            ...
            {
                con.Open();
                SqlCommand cmd = new SqlCommand("sp_ListarCatalogo", con);
                ...
                using (var dr = cmd.ExecuteReader())
                {
                    while (dr.Read())
                    {
                        ...
                        {
                            CatalogoId = Convert.ToInt32(dr["Catalogo_id"]),
        ...
        public CatalogoModel ObtenerId(int I_ID)
        {
            var oI_ID = new CatalogoModel();
            var cn = new Conexion();
            using (var con = new SqlConnection(cn.getconexion()))
            {
                con.Open();
                SqlCommand cmd = new SqlCommand("sp_ObtenerIdCatalogo", con);
                ...
                using(var dr = cmd.ExecuteReader())
                {
                    while (dr.Read())
                    {
                        oI_ID.CatalogoId = Convert.ToInt32(dr["Catalogo_id"]);
        ...
        public bool Editar(CatalogoModel oEditarI)
        {
            bool rpta;
            ...
            try
            {
                ...
                {
                    con.Open();
                    SqlCommand cmd = new SqlCommand("sp_EditarCatalogo", con);
